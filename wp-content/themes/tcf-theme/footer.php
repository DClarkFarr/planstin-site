		...
		<section class="section footer-cta bg-theme text-white">
			<div class="container">
				<div class="d-lg-flex text-center text-lg-left align-items-center">
					...
					<div class="ml-auto">
						<button class="btn btn-light btn-rounded">REGISTER</button>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-3">
							...
							<div class="media mb-4">
								<div class="bg-darker p-3 mr-3 icon text-white">
									<i class="far fa-question f-15"></i>
								</div>
							...
							<div class="media">
								<div class="bg-darker p-3 mr-3 icon text-white">
									<i class="far fa-user-tie f-15"></i>
								</div>
								<div class="media-body text-lighter">
						...
						<div class="col-lg-3">
							...
							<div class="mb-4">
								...
								<span class="bg-darker py-1 px-2 mb-2 d-inline-block rounded">Payroll</span>
							</div>
